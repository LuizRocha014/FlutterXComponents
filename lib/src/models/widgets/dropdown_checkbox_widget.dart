...
class _DropDownCheckBoxWidgetState<T> extends State<DropDownCheckBoxWidget<T>> {
              ...
              child: Flexible(
                child: Padding(
                  ...
                  child: TextWidget(
                    ...
                    textColor: widget.externalLabelColor ?? blackText,
                    fontSize: mediumFont,
                  ),
                ),
              ),
            ),
            TextWidget(widget.mandatory ? " *" : null, textColor: Colors.red),
          ],
        ),
          ...
          children: [
            DropdownButtonHideUnderline(
              ...
              child: DropdownButtonFormField<T>(
                ...
                icon: const Icon(Icons.keyboard_arrow_down, color: darkGray),
                ...
                decoration: InputDecoration(
                  counterText: '',
                  helperStyle: TextStyle(fontSize: tinyFont, color: redHelperText),
                  errorMaxLines: 2,
                        ...
                        child: StatefulBuilder(
                          builder: (context, setStateSb) {
                            ...
                            Color getColor(Set<WidgetState> states) {
                              if (e.isSelected) {
                                return widget.checkboxColor ?? black;
                              }
                              return white;
                            }
                ...
                child: GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: TextWidget(
                      ...
                      overflow: TextOverflow.ellipsis,
                      fontSize: smallFont,
                      textColor: selectedItens.isNotEmpty ? black : mediumGray,
                    ),
                  ),
                ),
              ),
  ...
  OutlineInputBorder get outlineInputBorder => OutlineInputBorder(
        borderSide: BorderSide(color: widget.borderColor ?? textFieldBorder),
